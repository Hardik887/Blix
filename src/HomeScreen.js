    ...
    <div className="homeScreen">
      <div className="homeScreen_background">
        <img
          ...
          src="https://res.cloudinary.com/hardiksinghrana/image/upload/v1641733823/Blix/BLIX_1__prev_ui_f434d0.png"
          alt=""
        />
        {!login && !signup && (
          <button className="homeScreen_button" onClick={() => setLogin(true)}>
            Sign In
          </button>
        )}
          ...
          <>
            ...
            <div className="homeScreen_input">
              <form onSubmit={() => setSignup(true)}>
                ...
                />
                <button type="submit" className="homeScreen_input_button">
                  GET STARTED
                </button>
              </form>
            </div>
