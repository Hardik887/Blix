                    ...
                    <div className='profileScreen_details'>
                        ...
                        <div className='profileScreen_plans'> 
                            ...
                            <div className='profileScreen_plan'>
                                ...
                                {plan==="Basic" ? <button className="profileScreen_disabled" disabled>Subscribed</button> : <button onClick={() => updatePlan("Basic")}>$9.99/month</button>}
                            </div>
                            <div className='profileScreen_plan'>
                                <div className='profileScreen_planInfo'>
                                    <h3>Standard</h3>
                                ...
                                {plan==="Standard" ? <button className="profileScreen_disabled" disabled>Subscribed</button> : <button onClick={() => updatePlan("Standard")}>$15.49/month</button>}
                            </div>
                            <div className='profileScreen_plan'>
                                <div className='profileScreen_planInfo'>
                                    <h3>Premium</h3>
                                ...
                                {plan==="Premium" ? <button className="profileScreen_disabled" disabled>Subscribed</button> : <button onClick={() => updatePlan("Premium")}>$19.99/month</button>}
                            </div>
                        </div>
